pipeline {
    ...
    parameter {
        string(name: 'USER_NAME', defaultValue: 'user1', description: 'User name to add to group')
        string(name: 'GROUP_NAME', defaultValue: 'testgroup1', description: 'Group name to add user to')
    }
        ...
        stage('Add User to Group') {
            steps {
                script {
                    ...
                    echo "User added to group: ${response}"
                }
            }
        }
